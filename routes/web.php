...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    // Thêm dòng này để người dùng lấy dữ liệu chat
    Route::post('/chat/get-data-client', [ChatController::class, 'getDataChatClient'])->name('chat.getDataChatClient');
...
Route::middleware(['auth', 'role:customer'])->prefix('customer')->group(function () {
    ...
    Route::post('/cartDT', [CustomerController::class, 'postCartDT'])->name('customer.postCartDT');
...
// Route cho Chatbot (Guest cũng dùng được)
Route::post('/chatbot/ask', [App\Http\Controllers\chatbot\ChatbotController::class, 'ask'])->name('guest.chatbot.ask');
// Route VNPAY Callback - PHẢI ĐẶT NGOÀI MIDDLEWARE AUTH
Route::get('/vnpay/callback', [CustomerController::class, 'vnpayCallback'])
    ->name('customer.order.vnpay.callback');