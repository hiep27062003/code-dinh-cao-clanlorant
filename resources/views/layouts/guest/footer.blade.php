    ...
    <div class="mid-footer">
        <div class="container">
            <div class="row row-fix">
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3 link-list col-footer footer-click col-fix">
                    <h4 class="title-menu title-menu2">MUA HÀNG</h4>
                    <ul class="list-menu hidden-mobile">
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3 link-list col-footer footer-click col-fix">
                    <h4 class="title-menu title-menu2">Điều khoản dịch vụ</h4>
                    <ul class="list-menu hidden-mobile">
                        <li><a href="/dieu-khoan-su-dung" title="Diều khoản dịch vụ">Diều khoản dịch vụ</a></li>
                        <li><a href="/dieu-khoan-html" title="Điều khoản sử dụng">Điều khoản sử dụng</a></li>
                ...
                <div class="col-6 col-md-6 col-lg-3 col-xl-3 link-list col-footer footer-click col-fix">
                    <h4 class="title-menu title-menu2">Liên Hệ</h4>
                    <ul class="list-menu hidden-mobile">
                        <li><a href="/" title="Mua hàng online: 0868">Mua hàng: 0868418343</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12">
                    ...
                    <span class="opacity1">Cung cấp bởi <a href="#" rel="noopener" title="Sapo" target="_blank">TH-36</a></span>
                </div>
            </div>
        </div>
    </div>
...
<div class="fixed-bottom-mobile d-lg-none d-block">
    <ul>
        <li><a href="/"><img width="25" height="25" src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/icon_fixed_1.png?1742954225872" alt="Trang chủ"><span>Trang chủ</span></a></li>
        <li class="menu-bar"><a href="javascript:void(0)"><img width="25" height="25" src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/icon_fixed_2.png?1742954225872" alt="Danh mục"><span>Danh mục</span></a></li>
        <li><a href="/cart"><img width="25" height="25" src="//bizweb.dktcdn.net/100/112/815/themes/966034/assets/icon_fixed_3.png?1742954225872" alt="Khuyến mãi"><span>Giỏ hàng</span><span class="count count_item_pr">3</span></a></li>
    </ul>
</div>
    ...
    <div class="listSharing_action">
        ...
        <ul class="addThis_listing">
            <li class="addThis_item">
                <a class="addThis_item--icon" href="tel:0867023153" title="Gọi ngay"><img src="https://img.icons8.com/color/48/000000/phone.png" width="40"><span class="tooltip-text">Gọi ngay</span></a>
            </li>
            <li class="addThis_item">
            ...
            <li class="addThis_item">
                <a class="addThis_item--icon" href="javascript:void(0)" onclick="window.toggleChatForm()">
                    ...
                    <span class="tooltip-text">Chat hỗ trợ</span>
                </a>
                
                <div id="chatForm" class="chat-box hidden">
                    <div class="chat-header">
                        <strong>💬 Chat với chúng tôi</strong>
                        <button type="button" onclick="window.toggleChatForm()" style="background:none;border:none;color:white;font-size:18px;">✖</button>
                    </div>
                    
                    <!-- TOGGLE CHẾ ĐỘ: Bot AI / Admin -->
...
<script type="module">
    ...
    // ==========================================
    // 2. UI MANAGER (Quản lý giao diện chung)
    // ==========================================
    const ChatUI = {
        dom: {
        ...
        toggle: function() {
            ...
            if (!this.dom.form.classList.contains('hidden')) {
                // Nếu mở form, khởi tạo dựa theo mode hiện tại
        ...
        switchMode: function(mode) {
            ...
            // Ẩn/Hiện nút attach file
            this.dom.btnAttach.style.display = (mode === 'bot') ? 'none' : 'block';

            // Clear màn hình & Khởi tạo service tương ứng
    ...
    // ==========================================
    // 3. BOT SERVICE (Xử lý Logic AI)
    // ==========================================
    const BotService = {
        init: function() {
            // Tin nhắn chào mừng
            ChatUI.renderMessage({
                message: 'Xin chào! Em là Bot AI. Anh/chị cần tư vấn gì ạ?',
                sender_id: 'bot',
                created_at: new Date(),
                isBot: true
            });
        ...
        handleSend: async function(message) {
            ...
            try {
                ...
                // Nếu backend trả về suggestions, hiển thị chúng
    ...
    // ==========================================
    // 4. ADMIN SERVICE (Xử lý Logic Chat Admin)
    // ==========================================
    const AdminService = {
        init: function() {
            if (!AppConfig.userId) {
                ChatUI.dom.messages.innerHTML = `
                    <div class="chat-list left">
                        <div class="user-chat-content">
                            <p>Vui lòng <a href="/login" style="color:blue">đăng nhập</a> để chat với Admin!</p>
                        </div>
                    </div>`;
                return;
            }
        ...
        handleSend: async function(message, file) {
            ...
            try {
                ...
                // Thành công - không cần làm gì vì renderMessage đã chạy ở Main Controller
                // và Realtime sẽ lo phần còn lại nếu cần xác nhận từ server
            } catch (error) {
                console.error("Admin Send Error:", error);
                alert("Lỗi gửi tin nhắn: " + (error.response?.data?.message || "Lỗi kết nối"));
            }
        },
            ...
            if (AppConfig.userId && window.Echo) {
                Echo.private(`chat.${AppConfig.userId}`)
                    .listen('.MessageSent', (e) => {
                        // Chỉ hiển thị nếu đang ở tab Admin và người gửi không phải là mình
    ...
    // ==========================================
    // 5. MAIN CONTROLLER (Điều phối)
    // ==========================================
    
    // Gắn sự kiện Global cho HTML gọi vào
    ...
    window.handleSendMessage = function(event) {
        ...
        // 1. Hiển thị tin nhắn của User lên màn hình ngay lập tức (Optimistic UI)
        ChatUI.renderMessage({
            message: message,
        ...
        // session id is handled inside BotService.handleSend
    };
